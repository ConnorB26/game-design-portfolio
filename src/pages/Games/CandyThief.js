...
import mainMenu from '../../assets/Game Materials/JPG MainMenus/CandyThief-MainMenu.jpg';
import ss1 from '../../assets/Game Materials/JPG Screenshots/CandyThief1.jpg';
import ss2 from '../../assets/Game Materials/JPG Screenshots/CandyThief2.jpg';

const ss = [{ image: mainMenu }, { image: ss1 }, { image: ss2 }];

export const CandyThief = () => {
  return (
    <Template title = "Candy Thief" 
